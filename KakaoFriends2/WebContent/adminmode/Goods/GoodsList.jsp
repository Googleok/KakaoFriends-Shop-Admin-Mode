...
<div id="mArticle">
	<div class="A"align="center">
	 ...
	 <div class=" ">
		<!-- ======================================================================================= -->
		<h2 class="title">Goods 전체 리스트</h2><br>
				...
				<div class="">
                  ...
                  <c:forEach items="${list}" var="dto">
                     <tr>
                        ...
                        <td>${dto.GCATEGORY}</td>
                        <td>${dto.GDIST}</td>
                        <td><img src="/KakaoFriends2/kakao_images/${dto.GMAIN1}" class="img-thumbnail"/></td>
                     </tr>
                     <tr>
                        <td colspan="3">
                        <a href="./GoodsDeleteAction.go?gid=${dto.GID}">굿즈 삭제</a>
                        </td>
                        <td colspan="3">
                        <a href="./GoodsModifyAction_WriteForm.go?gid=${dto.GID}">굿즈 수정</a>
                        </td>
                     </tr>
                  </c:forEach>
               </table>
