...
<div id="mArticle">
	<div class="A"align="center">
		...
		<form method="post" class="" action="./GoodsModifyAction.go" enctype="multipart/form-data">
         ...
         <div class="">
            ...
            <div class="" data-component-textfield="">
               ...
               <input type="text" class="" name="dist" id="dist" />
         ...
         <div class="">
            <label class=""></label>
            <input type="submit" class="" value="굿즈 상품  수정하기" />
         </div>
