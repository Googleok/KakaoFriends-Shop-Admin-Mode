...
<link rel="stylesheet" type="text/css" href="../../resources/css/fonts.css?20180646bc4703b04c29926e72a9cf4b33ae21kfo-store-web62506">
<link rel="stylesheet" type="text/css" href="../../resources/css/new_common.css?20180646bc4703b04c29926e72a9cf4b33ae21kfo-store-web62506">
<!--[if lt IE 9]>
...
<script type="text/javascript" src="../../resources/js/slick.js?20180646bc4703b04c29926e72a9cf4b33ae21kfo-store-web62506"></script>
<script type="text/javascript" src="../../resources/js/friends.js?20180646bc4703b04c29926e72a9cf4b33ae21kfo-store-web62506"></script>
<script type="text/javascript" src="../../resources/js/common.js?20180646bc4703b04c29926e72a9cf4b33ae21kfo-store-web62506"></script>
<script type="text/javascript" src="../../resources/js/validation.js?20180646bc4703b04c29926e72a9cf4b33ae21kfo-store-web62506"></script>
<script type="text/javascript" src="../../resources/js/jquery.blockUI.js?20180646bc4703b04c29926e72a9cf4b33ae21kfo-store-web62506"></script>
...
<div id="kakaoWrap">
    ...
    <h1 class="tit_head">
        <a href="../../main.jsp" id="kakaoServiceLogo" class="img_gnb link_friends ">KAKAO FRIENDS</a>
    </h1>
    ...
    <div id="kakaoGnb" role="navigation">
        ...
        <ul class="gnb_newfriends"  >
            <li class="">
                <a href="../products/groups/categories/3.jsp" class="link_gnb">카테고리</a>
                <div class="lnb_friends lnb_cate">
                    <div class="box_cate">
                        <strong class="tit_cate">전체 분류</strong>
                        <div class="sub_cate sub_cate1 on">
                            <a href="../products/groups/categories/3.jsp" class="link_cate">
                        ...
                        <!-- <div class="sub_cate sub_cate2">
                                ...
                                <div class="sub_cate sub_cate3">
                                    <a href="../products/groups/categories/64.jsp" class="link_cate">
                                ...
                                <div class="sub_cate sub_cate4">
                                    <a href="../products/groups/categories/22.jsp" class="link_cate">
                                ...
                                <div class="sub_cate sub_cate5">
                                    <a href="../products/groups/categories/13.jsp" class="link_cate">
                                ...
                                <div class="sub_cate sub_cate6">
                                    <a href="../products/groups/categories/14.jsp" class="link_cate">
                                ...
                                <div class="sub_cate sub_cate7">
                                    <a href="../products/groups/categories/24.jsp" class="link_cate">
                                ...
                                <div class="sub_cate sub_cate8">
                                    <a href="../products/groups/categories/15.jsp" class="link_cate">
                                ...
                                <div class="sub_cate sub_cate9">
                                    <a href="../products/groups/categories/17.jsp" class="link_cate">
                                ...
                                <div class="sub_cate sub_cate10">
                                    <a href="../products/groups/categories/16.jsp" class="link_cate">
                                ...
                                <div class="sub_cate sub_cate11">
                                    <a href="../products/groups/categories/115.jsp" class="link_cate">
            ...
            <li>
                <a href="./home.jsp" class="link_gnb">스토리</a>
            </li>
            <li class="item_gnb">
                <a href="../../museum.jsp" class="link_gnb">뮤지엄</a>
                <strong class="screen_out">서브메뉴</strong>
                <div class="lnb_friends lnb_museum">
                    <a href="../../museum.jsp" class="link_lnb" target="_blank">뮤지엄 소개</a>
                </div>
            </li>

            <li>
                <a href="../info/storeInfo.jsp" class="link_gnb">매장안내</a>
            </li>
            <li class="item_gnb">
                <a href="../customcenter/bnotice.jsp" class="link_gnb">고객센터</a>
            </li>
        </ul>
    </div>
    <div class="wrap_util"><!-- 마이메뉴 오버 시 mypage_on 클래스 추가 -->
        ...
        <a href="/en/brand/kconLA" class="link_lang"><span class="img_gnb ico_global">영어로 언어 변경</span></a>
        </div>
</div>
<script type="text/javascript">
	...
	function loginKakao(param){
		$.ajax({
			headers: {'X-CSRF-TOKEN': '942e0f5a-7c7d-497b-a39e-ef279ced56a9'},
			url : '/kakao/auth',
			type: "POST",
			data : $.param(param),
			async : false,
			...
			success : function(){
				$(location).attr('href', '/kr/brand/kconLA?');
			}
		});
	}
...
<div id="mArticle">
    ...
    <div class="view_brand view_video">
        ...
        <!-- <div class="section_goods">
                <h3 class="tit_main" style="color:#000">텍스트 컬러 인라인으로 적용연관 상품</h3>
                <ul class="list_goods">
                    <li>
                            <a href="/kr/products/4482" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBRYMAT0001_AW_00_RE.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">플로팅_매트튜브-써핑보드 라이언</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">35,000</em>원 <span class="usd_price">32.6 USD</span></span>
                                    </span>
                                </div>
                            </a>
                        </li>
                    <li>
                            <a href="/kr/products/4481" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBAPMAT0002_AW_00_RE.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">플로팅_매트튜브-써핑보드 어피치</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">35,000</em>원 <span class="usd_price">32.6 USD</span></span>
                                    </span>
                                </div>
                    ...
                    <li>
                            <a href="/kr/products/4483" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBRYMAT0003_AW_00_RE.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">플로팅_라이언 페이스 매트튜브</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">59,000</em>원 <span class="usd_price">54.96 USD</span></span>
                                    </span>
                                </div>
                            </a>
                        </li>
                    <li>
                            <a href="/kr/products/4284" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2F8809557980696_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">언더더씨 아이스텀블러 라이언</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">13,800</em>원 <span class="usd_price">12.86 USD</span></span>
                                    </span>
                                </div>
                            </a>
                        </li>
                    <li>
                            <a href="/kr/products/4285" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2F8809557980702_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">언더더씨 아이스텀블러 어피치</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">13,800</em>원 <span class="usd_price">12.86 USD</span></span>
                                    </span>
                                </div>
                    ...
                    <li>
                            <a href="/kr/products/4226" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBAPSCF8101_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">쁘띠 스카프-어피치</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">14,000</em>원 <span class="usd_price">13.04 USD</span></span>
                                    </span>
                                </div>
                            </a>
                        </li>
                    <li>
                            <a href="/kr/products/3648" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBAPSTB0001_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">어피치빨대텀블러(진핑크)</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">16,000</em>원 <span class="usd_price">14.9 USD</span></span>
                                    </span>
                                </div>
                            </a>
                        </li>
                    <li>
                            <a href="/kr/products/2960" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBRYSPD0005_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">45cm-Little라이언</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">39,000</em>원 <span class="usd_price">36.33 USD</span></span>
                                    </span>
                                </div>
                            </a>
                        </li>
                    <li>
                            <a href="/kr/products/2485" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2F_FRPBAPSPD0003_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">45cm인형-리틀어피치</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">39,000</em>원 <span class="usd_price">36.33 USD</span></span>
                                    </span>
                                </div>
                    ...
                    <li>
                            <a href="/kr/products/800" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBRN35D0396_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">라이언 35cm 인형</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">28,000</em>원 <span class="usd_price">26.08 USD</span></span>
                                    </span>
                                </div>
                            </a>
                        </li>
                    <li>
                            <a href="/kr/products/4485" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBRYFSP0001_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">플로팅_썸머라이언</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">27,000</em>원 <span class="usd_price">25.15 USD</span></span>
                                    </span>
                                </div>
                            </a>
                        </li>
                    <li>
                            <a href="/kr/products/4484" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBAPFSP0002_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">플로팅_썸머어피치</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">27,000</em>원 <span class="usd_price">25.15 USD</span></span>
                                    </span>
                                </div>
                    ...
                    <li>
                            <a href="/kr/products/2974" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBAPNBP0002_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">리본 바디필로우-어피치</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">39,000</em>원 <span class="usd_price">36.33 USD</span></span>
                                    </span>
                                </div>
                    ...
                    <li>
                            <a href="/kr/products/2973" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBRYNBP0001_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">리본 바디필로우-라이언</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">39,000</em>원 <span class="usd_price">36.33 USD</span></span>
                                    </span>
                                </div>
                    ...
                    <li>
                            <a href="/kr/products/2145" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBTBLFT0015_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">25cm인형리틀프렌즈-라이언</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">24,000</em>원 <span class="usd_price">22.36 USD</span></span>
                                    </span>
                                </div>
                            </a>
                        </li>
                    <li>
                            <a href="/kr/products/2140" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBAPLFT0010_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">25cm인형리틀프렌즈-어피치</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">24,000</em>원 <span class="usd_price">22.36 USD</span></span>
                                    </span>
                                </div>
                    ...
                    <li>
                            <a href="/kr/products/2969" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBRYFCS0015_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">얼굴쿠션-후드라이언(TS)</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">24,000</em>원 <span class="usd_price">22.36 USD</span></span>
                                    </span>
                                </div>
                    ...
                    <li>
                            <a href="/kr/products/885" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBRN15D0430_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">미니인형_후드라이언</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">12,000</em>원 <span class="usd_price">11.18 USD</span></span>
                                    </span>
                                </div>
                            </a>
                        </li>
                    <li>
                            <a href="/kr/products/3438" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBRYRMP0001_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">미니인형-리본라이언</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">12,000</em>원 <span class="usd_price">11.18 USD</span></span>
                                    </span>
                                </div>
                    ...
                    <li>
                            <a href="/kr/products/1529" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBRNKC0450_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">전신키체인_라이언</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">6,000</em>원 <span class="usd_price">5.59 USD</span></span>
                                    </span>
                                </div>
                            </a>
                        </li>
                    <li>
                            <a href="/kr/products/1531" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBAPKC0451_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">전신키체인_어피치</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">6,000</em>원 <span class="usd_price">5.59 USD</span></span>
                                    </span>
                                </div>
                    ...
                    <li>
                            <a href="/kr/products/4480" class="link_goods">
                                <span class="frame_thumb"><img src="https://img1.daumcdn.net/thumb/R300x300/?fname=https%3A%2F%2Ft1.daumcdn.net%2Ffriends%2Fprod%2Fproduct%2FFRPBRYFBB0004_AW_00.jpg" class="thumb_g" alt="">
</span>
                                <div class="info_item">
                                    <strong class="tit_item">플로팅_라이언 페이스 비치볼</strong>
                                    <span class="txt_price">
                                        <span class="screen_out">금액</span><span class="num_price"><em class="emph_g">7,000</em>원 <span class="usd_price">6.52 USD</span></span>
                                    </span>
                                </div>
                            </a>
                        </li>
