...
<head>
    <title>무릎담요-케로앤베로니 :: 카카오 프렌즈샵</title>
...
<link rel="stylesheet" type="text/css" href="./resources/css/fonts.css?2018a0a85aaad7e1459eb082afc71a02254320kfo-store-web2.dakao.io5750">
<link rel="stylesheet" type="text/css" href="./resources/css/new_common.css?2018a0a85aaad7e1459eb082afc71a02254320kfo-store-web2.dakao.io5750">
<!--[if lt IE 9]>
...
<script type="text/javascript" src="./resources/js/slick.js?2018a0a85aaad7e1459eb082afc71a02254320kfo-store-web2.dakao.io5750"></script>
<script type="text/javascript" src="./resources/js/friends.js?2018a0a85aaad7e1459eb082afc71a02254320kfo-store-web2.dakao.io5750"></script>
<script type="text/javascript" src="./resources/js/common.js?2018a0a85aaad7e1459eb082afc71a02254320kfo-store-web2.dakao.io5750"></script>
<script type="text/javascript" src="./resources/js/validation.js?2018a0a85aaad7e1459eb082afc71a02254320kfo-store-web2.dakao.io5750"></script>
<script type="text/javascript" src="./resources/js/jquery.blockUI.js?2018a0a85aaad7e1459eb082afc71a02254320kfo-store-web2.dakao.io5750"></script>
...
<!-- 페이스북 -->
	<meta property="og:title" content="무릎담요-케로앤베로니">
	<meta property="og:description" content="무릎담요-케로앤베로니 :: 카카오 프렌즈샵">
	<meta property="og:image" content="https://t1.daumcdn.net/friends/prod/product/FRPBKBNBK0001_AW_00.jpg">
	<meta property="og:image:width" content="500">
	<meta property="og:image:height" content="500">
    <!-- 트위터 -->
	<meta name="twitter:card" content="summary">
	<meta name="twitter:title" content="무릎담요-케로앤베로니 :: 카카오 프렌즈샵">
	<meta property="twitter:image" content="https://t1.daumcdn.net/friends/prod/product/FRPBKBNBK0001_AW_00.jpg">
	</head>
<body>
<script type="application/ld+json">
    ...
    "@type":"Product",
    "productID":"FRPBKBNBK0001",
    "name":"무릎담요-케로앤베로니",
    "description":"무릎담요-케로앤베로니",
    "url":"http://store.kakaofriends.com/kr/products/4658",
    "image": "https://t1.daumcdn.net/friends/prod/product/FRPBKBNBK0001_AW_00.jpg",
    "brand":"카카오프렌즈",
    "offers":[
    {
    "@type":"Offer",
...
<script>
  fbq('track', 'ViewContent', {
    value: 15000,
    currency: 'KRW',
    content_ids: ['FRPBKBNBK0001'],
    content_name: '무릎담요-케로앤베로니',
    content_type: 'product',
    content_category: '케로&베로니',
  });
  ga('send', {
    hitType: 'event',
...
GoodsBean detail= new GoodsBean();
detail=(GoodsBean)session.getAttribute("goods_detail");
	
%>
<div id="mSub">
		<div class="box_visual detail_visual">
			<div class="item_visual" style="background-image:url('/KakaoFriends2/kakao_images/<%=detail.getGMAIN1()%>')">
				<img src="/KakaoFriends2/kakao_images/<%=detail.getGMAIN1()%>" class="thumb_g" alt="제품 상세사진">
			</div>
			<div class="item_visual" style="background-image:url('/KakaoFriends2/kakao_images/<%=detail.getGMAIN2()%>')">
				<img src="/KakaoFriends2/kakao_images/<%=detail.getGMAIN2()%>" class="thumb_g" alt="제품 상세사진">
			</div>
			<div class="item_visual" style="background-image:url('/KakaoFriends2/kakao_images/<%=detail.getGMAIN3()%>')">
				<img src="/KakaoFriends2/kakao_images/<%=detail.getGMAIN3()%>" class="thumb_g" alt="제품 상세사진">
			</div>
			</div>
	</div>
<div id="mArticle">
	...
	<div class="cont_detail">
		<div class="inner_detail">
			...
			<h3 class="tit_detail"><%=detail.getGNAME()%></h3>

			<span class="price_info">
				<span class="screen_out">금액</span>
						<span class="current_price" data-regular-price="15000">
							<%=detail.getGPRICE()%>원
							</span>
					</span>

			<div class="cont_about"><p>&nbsp;</p>


<p>&nbsp;</p>

<p><img alt="" src="/KakaoFriends2/kakao_images/<%=detail.getGMAIN1()%>" style="width: 1280px; height: 960px;" /></p>

<p>&nbsp;</p>

<p><img alt="" src="/KakaoFriends2/kakao_images/<%=detail.getGMAIN2()%>" style="width: 1280px; height: 960px;" /></p>

<p>&nbsp;</p>

<p><img alt="" src="/KakaoFriends2/kakao_images/<%=detail.getGMAIN3()%>" style="width: 1280px; height: 960px;" /></p>

<p>&nbsp;</p>

<p><img alt="" src="/KakaoFriends2/kakao_images/<%=detail.getGSUB1()%>" style="width: 1280px; height: 960px;" /></p>

<p>&nbsp;</p>

<p><img alt="" src="/KakaoFriends2/kakao_images/<%=detail.getGSUB2()%>" style="width: 1280px; height: 960px;" /></p>

<p>&nbsp;</p>

<p><img alt="" src="/KakaoFriends2/kakao_images/<%=detail.getGSUB3()%>" style="width: 1280px; height: 960px;" /></p>

<p>&nbsp;</p>

<p><img alt="" src="/KakaoFriends2/kakao_images/<%=detail.getGSUB4()%>" style="width: 1280px; height: 960px;" /></p>

<p>&nbsp;</p>

<p><img alt="" src="/KakaoFriends2/kakao_images/<%=detail.getGSUB5()%>" style="width: 1280px; height: 960px;" /></p>

<p>&nbsp;</p>

<p><img alt="" src="/KakaoFriends2/kakao_images/<%=detail.getGSUB6()%>" style="width: 1280px; height: 960px;" /></p>

<p>&nbsp;</p>

<p><img alt="" src="/KakaoFriends2/kakao_images/<%=detail.getGSUB7()%>" style="width: 1280px; height: 960px;" /></p>

<p>&nbsp;</p>

<p><img alt="" src="/KakaoFriends2/kakao_images/<%=detail.getGSUB8()%>" style="width: 1280px; height: 960px;" /></p>
...
<p><strong>[ 국내 배송 ]</strong></p>

<p><u><strong>배송</strong></u><br />
&middot; 배송사: CJ대한통운<br />
&middot;&nbsp;배송비: 국내 2,500원 (3만 원 이상 구매 시 무료배송)<br />
&middot;&nbsp;배송기간: 오후 3시 이전 주문 당일 출고 (영업일 기준)<br />
&nbsp; 단, 상품의 재고 상황, 배송량, 배송 지역에 따라 배송기일이 추가로 소요될 수 있는 점 양해 부탁드립니다.</p>

<p><u><strong>취소/교환/반품</strong></u><br />
&middot;&nbsp;주문 취소 및 배송지 변경은 &ldquo;주문접수&rdquo; 단계에서만 가능합니다.<br />
&nbsp; 마이페이지에서 취소 또는 변경하실 수 있습니다.<br />
&middot;&nbsp;교환 및 반품은 배송완료 후 7일 이내만 가능합니다.<br />
&nbsp; 단, 재화 등의 내용이 표시, 광고 내용과 다르거나 계약내용을 다르게 이행한 경우에는 재화 등을 공급받은 날로부터 3개월 이내, 그 사실을 안 날 또는 알 수 있었던 날로부터 30일 이내에 교환 및 반품이 가능합니다.<br />
&middot;&nbsp;다음의 경우 교환 및 반품이 불가합니다.<br />
&nbsp; -&nbsp;이용자에게 책임 있는 사유로 재화 등이 멸실 또는 훼손된 경우<br />
&nbsp; - 포장이 훼손되어 상품가치가 상실된 경우 (예: 택과 라벨이 훼손된 경우 등)<br />
&nbsp; - 이용자의 사용 또는 일부 소비에 의해 재화 등의 가치가 현저히 감소한 경우<br />
&nbsp; - 복제가 가능한 재화 등의 포장을 훼손한 경우<br />
&nbsp; - 시간 경과에 의하여 재판매가 곤란할 정도로 상품의 가치가 현저히 감소한 경우<br />
&nbsp; - 고객의 주문에 따라 개별 생산되는 상품의 경우<br />
&middot;&nbsp;상품의 불량/하자 및 표시광고 및 계약 내용이 다른 경우 해당 상품의 회수 비용은 무료이나, 고객님의 단순변심에 의한 교환/반품일 경우에는 교환/반품 배송비를 고객님께서 직접 부담하셔야 합니다.</p>

<p><u><strong>환불</strong></u><br />
&middot;&nbsp;주문취소 및 반품 시 환불은 주문 시 이용하신 결제수단으로 2~7 영업일 이내 환불됩니다.&nbsp;</p>

<p><u><strong>기타 문의</strong></u><br />
&middot;&nbsp;기타 교환 및 반품에 대한 문의는 1:1 문의하기 또는 1577-6263으로 문의해주세요.</p>

<p>&nbsp;</p>

<p><strong>[ 글로벌 배송 ]</strong></p>

<p><u><strong>배송</strong></u><br />
&middot;&nbsp;배송사: EMS<br />
&middot;&nbsp;배송비: EMS 요금 적용<br />
&middot;&nbsp;국가별 배송비는 글로벌 배송 안내 페이지를 참고해주세요. (홈페이지 하단 글로벌배송)<br />
&middot;&nbsp;배송기간: 주문일로부터 1~3일 이내 출고<br />
&nbsp; 단, 상품의 재고 상황, 배송량에 따라 배송기일이 추가적으로 소요될 수 있는 점 양해 부탁드립니다.</p>

<p><u><strong>취소/교환/반품</strong></u><br />
&middot;&nbsp;주문 취소 및 배송지 변경은 &ldquo;주문접수&rdquo; 단계에서만 가능합니다.<br />
&nbsp; 마이페이지에서 취소 또는 변경하실 수 있습니다.<br />
&middot;&nbsp;글로벌 배송 구매 시, 단순 변심에 의한 교환 및 반품이 불가합니다.</p>

<p><u><strong>통관/관세</strong></u><br />
&middot;&nbsp;국가 세관 규정에 따르면, 배송 과정에서 나라별로 관세가 발생할 수 있으며 관세는 고객 부담입니다.&nbsp;<br />
&nbsp; 상세 문의사항은 가까운 우체국이나 세관 또는 거주하시는 국가의 우체국에 문의바랍니다.<br />
&middot;&nbsp;배송 국가별 금지 및 제한 품목을 주문 전 확인 바랍니다.</p>

<p><u><strong>기타 문의</strong></u><br />
&middot;&nbsp;기타 문의사항은 1:1 문의 또는 global@kakaofriends.com 으로 문의해주세요.</p>
</div>
...
<script>
	...
	<div class="box_purchase "><!-- 임시저장 상태 중 옵션이 닫힌상태 option_open / 옵션이 열린상태 option_close -->
		<div class="inner_purchase">
			<h3 class="screen_out">제품 구매하기</h3>
			<form id="myForm" name="myForm" action="./GoodsPay.go" method="post">
				<fieldset>
					<legend class="screen_out">제품 구매양식</legend>
					<input type="hidden" name="_csrf" value="ba6f617d-005a-4753-8f62-1041b771435d"/>
					<input type="hidden" name="_csrf_header" value="X-CSRF-TOKEN"/>
					<input type="hidden" name="prCode" value="FRPBKBNBK0001">
						<input type="hidden" name="prCodes" value="FRPBKBNBK0001">
					<input type="hidden" name="prEas" id="prEas">
					<input type="hidden" name="ctSeq" value="116">
					<input type="hidden" name="bsSeq" id="bsSeq">
					<input type="hidden" name="isGiftBag" value="false">
					<input type="hidden" name="detail_goods" value="<%=detail.getGID()%>">

					<div class="check_btn">
										<button type="button" class="btn_basket " onclick="basket_go();">
									...
									<div class="item_option">
												<div class="box_quantity">
													...
													<input type="text" id="gcount" class="inp_quantity" name="gcount" value="1">
												...
												<div class="pay_price">
													...
													<em class="emph_price">
														<%=detail.getGPRICE() %><span class="txt_won">원
															
															<span class='usd_price'>(<%=String.format("%.2f", detail.getGPRICE()*0.00088)%> USD)</span>
														</span>
													</em>
												</div>
												<button type="button" class="btn_close"><span class="ico_friends ico_close">옵션 닫기</span></button>
											</div>
											<button type="button" class="btn_open" onclick="goSubmit();"><span class="txt_g">구매하기</span></button>
											<button type="button" class="btn_buy" onclick="goSubmit();"><span class="txt_g">구매하기</span></button>
										</fieldset>
			</form>
			
			<form id="basket_gogo" name="basket_gogo" action="./GoodsBasket.go" method="post">
				<input type="hidden" name="gid" value="<%=detail.getGID()%>">
				<input type="hidden" name="gname" value="<%=detail.getGNAME()%>">
				<input type="hidden" name="gprice" value="<%=detail.getGPRICE()%>">
				<input type="hidden" name="gmain" value="<%=detail.getGMAIN1()%>">
			</form>
	...
	<div class="cont_detail detail_product">
		<div class="inner_detail">
            <a href="/kr/promotions/recruit" class="link_bnr rw_show"><img src="https://t1.daumcdn.net/friends/prod/banner/W_banner_band_2x5.jpg" class="img_bnr" alt=""></a>
				<a href="/kr/promotions/recruit" class="link_bnr rw_hide"><img src="https://t1.daumcdn.net/friends/prod/banner/M_banner_band_2x11.jpg" class="img_bnr" alt=""></a>
