...
<meta property="og:title" content="카카오프렌즈 - 마이페이지">
		<meta property="og:description" content="공식 온라인스토어">
        <meta property="og:image" content="https://t1.daumcdn.net/friends/www/resources/images/pc/bg_mypage_170103.jpg">
...
<div id="mSub">
	<div class="visual_intro mypage_intro" style="background-color:#ffdc00"><!-- 인라인스타일로 배경컬러값 변경 -->
		<div class="inner_intro">
			...
			<div class="profile_user">
				<strong class="tit_username">안녕하세요,</br> <span class="txt_name">고객</span>님</strong>
	...
	<div class="box_useinfo">
		...
		<dl class="info_mypoint">
			...
			<dd class="item_total"><a href="/kr/mypage/pointlist" class="link_point"><em class="num_point">1,000</em><span class="ico_newfriends_v1 ico_point">P</span></a></dd>
			<dt class="screen_out">사용가능 포인트 </dt>
			<dd><em class="num_point">0 P</em> 사용 가능</dd>
		</dl>
		<div class="group_infobox">
			<dl class="info_coll">
				<dt>배송중 </dt>
				<!-- 2017-10-24 수정 : a태그 추가 및 숫자 0일때 dd에 num_basic 클래스 추가 -->
				<dd class=num_basic><a href="/kr/mypage/orderlist" class="link_info">0</a></dd>
			</dl>
			<dl class="info_coll">
				<dt>취소 및 교환 </dt>
				<!-- 2017-10-24 수정 : a태그 추가 및 숫자 0일때 dd에 num_basic 클래스 추가 -->
			...
			<dl class="info_coll">
				<dt>쿠폰 </dt>
				<!-- 2017-10-24 수정 : a태그 추가 및 숫자 0일때 dd에 num_basic 클래스 추가 -->
				<dd class=num_basic><a href="/kr/mypage/couponlist" class="link_info">0</a></dd>
			</dl>
		</div>
	</div>
</div>
...
</div><a href="/kr/mypage/onetoone/form" class="link_quest">문의하기</a>
	</div>
</div>
