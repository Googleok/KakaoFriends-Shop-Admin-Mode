...
<meta property="og:title" content="카카오프렌즈 - 니니즈">
		<meta property="og:description" content="공식 온라인스토어">
		<meta property="og:image" content="https://t1.daumcdn.net/friends/prod/category/20181002_W_categorytop_niniz_4360ab.jpg">
...
<div id="mSub">
	<div class="box_intro cate_intro" style="background-color:#4360ab">
		<div class="inner_intro">
			<img src="https://t1.daumcdn.net/friends/prod/category/20181002_W_categorytop_niniz_4360ab.jpg" class="img_intro rw_show" alt="니니즈">
			<img src="https://t1.daumcdn.net/friends/prod/category/20181002_M_categorytop_niniz_4360ab.jpg" class="img_intro rw_hide" alt="니니즈">
			<h2 id="kakaoBody" class="tit_intro">니니즈</h2>
			<em class="emph_en">NINIZ</em>
		</div>
	</div>
</div><div id="mArticle">
		...
		<div class="head_product">
			...
			<div class="wrap_tab">
				<ul class="tab_friends">
					<li class="on"><a href="./115.jsp" class="link_tab">전체<span class="screen_out">선택됨</span></a></li>
					<!-- <li class=""><a href="/kr/products/groups/categories/116?requestCategory=116" class="link_tab">케로&베로니</a></li>
					<li class=""><a href="/kr/products/groups/categories/117?requestCategory=117" class="link_tab">앙몬드</a></li>
					<li class=""><a href="/kr/products/groups/categories/118?requestCategory=118" class="link_tab">스카피</a></li> -->
					</ul>
			</div>
			<div class="wrap_opt">
				<div class="opt_sort">
...
<script>
    function sortList(){
        ...
        if(filterQuery == ""){
            window.location.href = "/kr/products/groups/categories/115" + "?"+ "requestCategory=115" + "&" + characterQuery + "&" + sortQuery;
        }else{
            window.location.href = "/kr/products/groups/categories/115" + "?"+ "requestCategory=115" + "&" + characterQuery + "&" + sortQuery + "&" + filterQuery;
        }
    }
