...
<meta property="og:title" content="카카오프렌즈 - 잡화">
		<meta property="og:description" content="공식 온라인스토어">
		<meta property="og:image" content="https://t1.daumcdn.net/friends/prod/category/W040_accessory_all.jpg">
...
<div id="mSub">
	<div class="box_intro cate_intro" style="background-color:#f1b1c5">
		<div class="inner_intro">
			<img src="https://t1.daumcdn.net/friends/prod/category/W040_accessory_all.jpg" class="img_intro rw_show" alt="잡화">
			<img src="https://t1.daumcdn.net/friends/prod/category/M040_accessory_all.jpg" class="img_intro rw_hide" alt="잡화">
			<h2 id="kakaoBody" class="tit_intro">잡화</h2>
			<em class="emph_en">Accessory</em>
		</div>
	</div>
</div><div id="mArticle">
		...
		<div class="head_product">
			...
			<div class="wrap_tab">
				<ul class="tab_friends">
					<li class="on"><a href="./13.jsp" class="link_tab">전체<span class="screen_out">선택됨</span></a></li>
...
%>
	...
	<span class="inner_paging">
		<span class="screen_out">현재 페이지</span><em class="link_page">1</em><span class="ico_newfriends_v1 ico_next">다음</span>
</span>
</div></div>
</div>
<script>
    function sortList(){
        ...
        if(filterQuery == ""){
            window.location.href = "/kr/products/groups/categories/13" + "?"+ "requestCategory=13" + "&" + characterQuery + "&" + sortQuery;
        }else{
            window.location.href = "/kr/products/groups/categories/13" + "?"+ "requestCategory=13" + "&" + characterQuery + "&" + sortQuery + "&" + filterQuery;
        }
    }
