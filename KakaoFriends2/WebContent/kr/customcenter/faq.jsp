...
<meta property="og:title" content="카카오프렌즈 - 고객센터">
        </head>
<body>
<div id="kakaoIndex">
...
<div id="mSub">
	<div class="box_intro" style="background-color:#41b984">
		<div class="inner_intro">
			<img src="https://t1.daumcdn.net/friends/www/resources/images/pc/bg_help_170103.jpg" class="img_intro rw_show" alt="고객센터">
			<img src="https://t1.daumcdn.net/friends/www/resources/images/m640/bg_help_170103.jpg" class="img_intro rw_hide" alt="고객센터">
			<h2 id="kakaoBody" class="tit_intro">고객센터</h2>
			<em class="emph_en">Help</em>
		</div>
	</div>
</div><div id="mArticle">
    <div class="cont_board">
        <div class="head_board">
            <ul class="tab_friends">
                <li>
                    <a class="link_tab" href="./bnotice.fo"> 공지사항 </a>
                </li>
                <li class="on">
                    <a class="link_tab" href="./faq.fo"> FAQ </a>
                </li>
            </ul>
            ...
            <div class="opt_sort"><!--펼침시 클래스 sort_open 부여-->
                ...
                <div class="box_sort">
                    ...
                    <ul class="list_sort">
                        ...
                        <li class="on"><!-- 선택시 on 클래스 부여 -->	<a class="link_sort" href="/kr/customcenter/faq/1" data-bdcseq="1">회원</a></li>
                        <li class="on"><!-- 선택시 on 클래스 부여 -->	<a class="link_sort" href="/kr/customcenter/faq/2" data-bdcseq="2">상품</a></li>
                        <li class="on"><!-- 선택시 on 클래스 부여 -->	<a class="link_sort" href="/kr/customcenter/faq/3" data-bdcseq="3">주문결제</a></li>
                        <li class="on"><!-- 선택시 on 클래스 부여 -->	<a class="link_sort" href="/kr/customcenter/faq/4" data-bdcseq="4">배송</a></li>
                        <li class="on"><!-- 선택시 on 클래스 부여 -->	<a class="link_sort" href="/kr/customcenter/faq/5" data-bdcseq="5">쿠폰</a></li>
                        <li class="on"><!-- 선택시 on 클래스 부여 -->	<a class="link_sort" href="/kr/customcenter/faq/6" data-bdcseq="6">교환/반품/환불</a></li>
                        <li class="on"><!-- 선택시 on 클래스 부여 -->	<a class="link_sort" href="/kr/customcenter/faq/7" data-bdcseq="7">기타</a></li>
                        <li class="on"><!-- 선택시 on 클래스 부여 -->	<a class="link_sort" href="/kr/customcenter/faq/9" data-bdcseq="9">해외배송</a></li>
                        </ul>
        ...
        <ul class="list_board">
            <li>
                <a class="link_board" href="#none">
                    <span class="txt_info">
                        <span class="txt_cate">[기타]</span>
                        <span class="screen_out">작성일</span>
                        </span>
                    <strong class="tit_board">Why does the “Site connection terminated. Please proceed again.” message pop up?</strong>
...
<p>&ldquo;Site connection terminated. Please proceed again.&rdquo;</p>

<p>&nbsp;</p>

<p>If the above message appears during the use of our site, simply refresh the page or try connecting to the page once more. After 30 minutes of inactivity with the screen left open, the session will automatically come to an end with the above message appearing.</p>
...
<p>&nbsp;</p>
            ...
            <li>
                <a class="link_board" href="#none">
                    <span class="txt_info">
                        <span class="txt_cate">[회원]</span>
                        <span class="screen_out">작성일</span>
                        </span>
                    <strong class="tit_board">How do I use a coupon?</strong>
                    <span class="ico_friends ico_arr">내용 펼치기</span>
                </a>
                <div class="subject_board">
                    <strong class="tit_answer">답변 :</strong>
...
<p>Select an available coupon you wish to use when purchasing an item.</p>

<p>&nbsp;</p>

<p><strong>Precautions for coupon use:</strong><br />
* Partial returns and exchanges are not allowed for purchases made with coupons.<br />
* Check coupon details prior to use as conditions for use vary per coupon.<br />
* Coupons are removed upon expiration.<br />
* Check available coupons by going to My page &gt; Coupon.</p>

<p>&nbsp;</p>

<p>Coupons may not be applicable to select products.<br />
We periodically conduct investigations into the misuse of points and coupons and may revoke membership, demand damage compensation or take other legal action if necessary in the event of points or coupons being resold for profit.</p>
...
<p>&nbsp;</p>
            ...
            <li>
                <a class="link_board" href="#none">
                    ...
                    <strong class="tit_board">How do I use my points?</strong>
                    <span class="ico_friends ico_arr">내용 펼치기</span>
                </a>
                <div class="subject_board">
                    <strong class="tit_answer">답변 :</strong>
...
<p>Enter the amount of points you wish to use when purchasing an item.</p>

<p>&nbsp;</p>

<p><strong>Precautions for point use:</strong><br />
* Partial returns and exchanges are not allowed for purchases made with points.<br />
* Points only become available for use after having earned 3,000 points or more.<br />
* Points are not applicable to shipping fees.<br />
Points are removed upon expiration following the six-month validity period.<br />
Check point validity period by going to My page &gt; Point &gt; Points details.</p>

<p>&nbsp;</p>

<p>Points may not be applicable to select products.<br />
We periodically conduct investigations into the misuse of points and coupons and may revoke membership, demand damage compensation or take other legal action if necessary in the event of points or coupons being resold for profit</p>
...
<p>&nbsp;</p>
            ...
            <li>
                <a class="link_board" href="#none">
                    ...
                    <strong class="tit_board">How do I cancel my membership?</strong>
                    <span class="ico_friends ico_arr">내용 펼치기</span>
                </a>
                <div class="subject_board">
                    <strong class="tit_answer">답변 :</strong>
...
<p>Log into your account and go to My page &gt; Account &gt; KakaoTalk Account &gt; Membership cancellation.<br />
Upon membership cancellation, all personal data is erased and the account may not be re-registered for membership for 30 days.</p>
...
<p>&nbsp;</p>
            ...
            <li>
                <a class="link_board" href="#none">
                    ...
                    <strong class="tit_board">How do I edit my account information?</strong>
                    <span class="ico_friends ico_arr">내용 펼치기</span>
                </a>
                <div class="subject_board">
                    <strong class="tit_answer">답변 :</strong>
...
<p>After logging into your account, go to My page &gt; Account &gt; KakaoTalk Account.</p>
...
<p>&nbsp;</p>
	...
	<span class="inner_paging">
		<a href="/kr/customcenter/faq/pages/1" class="link_page"><span class="ico_newfriends_v1 ico_prev">이전</span></a><span class="screen_out">현재 페이지</span><em class="link_page">1</em><a href="/kr/customcenter/faq/pages/2" class="link_page">2</a><a href="/kr/customcenter/faq/pages/3" class="link_page">3</a><a href="/kr/customcenter/faq/pages/4" class="link_page">4</a><a href="/kr/customcenter/faq/pages/5" class="link_page">5</a><a href="/kr/customcenter/faq/pages/6" class="link_page"><span class="ico_newfriends_v1 ico_next">다음</span></a>
</span>
</div></div>
</div></div>
		</div>
