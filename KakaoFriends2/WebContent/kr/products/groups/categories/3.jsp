...
<link rel="stylesheet" type="text/css" href="./resources/css/fonts.css?2018cece25504f6f4d96b161f7c8ddaa40ff19kfo-store-web101423">
<link rel="stylesheet" type="text/css" href="./resources/css/new_common.css?2018cece25504f6f4d96b161f7c8ddaa40ff19kfo-store-web101423">
<!--[if lt IE 9]>
...
<script type="text/javascript" src="./resources/js/slick.js?2018cece25504f6f4d96b161f7c8ddaa40ff19kfo-store-web101423"></script>
<script type="text/javascript" src="./resources/js/friends.js?2018cece25504f6f4d96b161f7c8ddaa40ff19kfo-store-web101423"></script>
<script type="text/javascript" src="./resources/js/common.js?2018cece25504f6f4d96b161f7c8ddaa40ff19kfo-store-web101423"></script>
<script type="text/javascript" src="./resources/js/validation.js?2018cece25504f6f4d96b161f7c8ddaa40ff19kfo-store-web101423"></script>
<script type="text/javascript" src="./resources/js/jquery.blockUI.js?2018cece25504f6f4d96b161f7c8ddaa40ff19kfo-store-web101423"></script>
...
<meta property="og:title" content="카카오프렌즈 - 카테고리">
		<meta property="og:description" content="공식 온라인스토어">
		<meta property="og:image" content="https://t1.daumcdn.net/friends/prod/category/W000_category_all.jpg">
...
<div id="mSub">
	<div class="box_intro cate_intro" style="background-color:#ffb900">
		<div class="inner_intro">
			<img src="https://t1.daumcdn.net/friends/prod/category/W000_category_all.jpg" class="img_intro rw_show" alt="카테고리">
			<img src="https://t1.daumcdn.net/friends/prod/category/M000_category_all0.jpg" class="img_intro rw_hide" alt="카테고리">
			<h2 id="kakaoBody" class="tit_intro">카테고리</h2>
...
<%
	...
	ArrayList result=(ArrayList)session.getAttribute("goods");
%>
	...
	%>
						<li>
							<a href="./GoodsDetail.go?gid=<%=goods.getGID()%>" class="link_product">
								...
								<a href="./GoodsBasket.go?gid=<%=goods.getGID()%>&gname=<%=goods.getGNAME()%>&gprice=<%=goods.getGPRICE()%>&gmain=<%=goods.getGMAIN1()%>"/><!-- 대표상품 설정 안되있을때 -->
...
%>
	...
	<span class="inner_paging">
		<a href="/kr/products/groups/categories/3/pages/1" class="link_page"></a><em class="link_page">1</em>
</span>
</div></div>
</div>
<script>
    function sortList(){
        ...
        if(filterQuery == ""){
            window.location.href = "/kr/products/groups/categories/3" + "?"+ "" + "" + characterQuery + "&" + sortQuery;
        }else{
            window.location.href = "/kr/products/groups/categories/3" + "?"+ "" + "" + characterQuery + "&" + sortQuery + "&" + filterQuery;
        }
    }
