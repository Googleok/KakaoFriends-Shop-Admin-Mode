...
<!doctype html>
<html lang="ko" class="windows msie pc">
<head>
...
<link rel="stylesheet" type="text/css" href="./resources/css/fonts.css?2018a0a85aaad7e1459eb082afc71a02254322kfo-store-web2.dakao.io4532">
<link rel="stylesheet" type="text/css" href="./resources/css/new_common.css?2018a0a85aaad7e1459eb082afc71a02254322kfo-store-web2.dakao.io4532">
<!--[if lt IE 9]>
...
<script type="text/javascript" src="./resources/js/slick.js?2018a0a85aaad7e1459eb082afc71a02254322kfo-store-web2.dakao.io4532"></script>
<script type="text/javascript" src="./resources/js/friends.js?2018a0a85aaad7e1459eb082afc71a02254322kfo-store-web2.dakao.io4532"></script>
<script type="text/javascript" src="./resources/js/common.js?2018a0a85aaad7e1459eb082afc71a02254322kfo-store-web2.dakao.io4532"></script>
<script type="text/javascript" src="./resources/js/validation.js?2018a0a85aaad7e1459eb082afc71a02254322kfo-store-web2.dakao.io4532"></script>
<script type="text/javascript" src="./resources/js/jquery.blockUI.js?2018a0a85aaad7e1459eb082afc71a02254322kfo-store-web2.dakao.io4532"></script>
...
<div id="mSub">
    <div class="order_intro">
        <div class="inner_intro">
            <h2 id="kakaoBody" class="tit_intro">주문하기</h2>
...
<%
	...
	ArrayList result = (ArrayList)session.getAttribute("goods_pay");
%>
   <div id="mArticle" class="IS_VUE">
                        <form id="orderGo" name="orderGo" method="post" action="./GoodsOrder.go" class="" onsubmit="return validate();">
                            <fieldset><input type="hidden" name="payMethodType"> <input type="hidden" name="bsSeqList" value="5943528,5935430"> <input type="hidden" name="accesstype" value="1"> <input type="hidden" name="goodname" value="세안밴드_베로니 외1개"> <input type="hidden" name="originalAmt" value="34000"> <input type="hidden" name="paymentAccountNotDeli" value="34000"> <input type="hidden" name="acceptmethod" value="SKIN(YELLOW):HPP(1):below1000:Vbank(20181202)"> <input type="hidden" name="currency" value="WON"> <input type="hidden" name="oid"> <input type="hidden" name="ini_logoimage_url"> <input type="hidden" name="ini_menuarea_url"> <input type="hidden" name="ini_encfield"> <input type="hidden" name="ini_certid"> <input type="hidden" name="ini_paymethod"> <input type="hidden" name="quotainterest"> <input type="hidden" name="paymethod"> <input type="hidden" name="cardcode"> <input type="hidden" name="cardquota"> <input type="hidden" name="rbankcode"> <input type="hidden" name="reqsign" value="DONE"> <input type="hidden" name="encrypted"> <input type="hidden" name="sessionkey"> <input type="hidden" name="uid"> <input type="hidden" name="sid"> <input type="hidden" name="version" value="5000"> <input type="hidden" name="clickcontrol" value="enable"> <input type="hidden" name="gopaymethod"> <input type="hidden" name="buyername"> <input type="hidden" name="buyeremail" value="@"> <input type="hidden" name="buyertel" value="82-"> <input type="hidden" name="P_APP_BASE"> <input type="hidden" name="P_MID"> <input type="hidden" name="P_OID"> <input type="hidden" name="P_AMT"> <input type="hidden" name="P_MNAME" value="카카오프렌즈 온라인 스토어"> <input type="hidden" name="P_UNAME"> <input type="hidden" name="P_GOODS"> <input type="hidden" name="P_NOTI"> <input type="hidden" name="P_HPP_METHOD"> <input type="hidden" name="P_MOBILE"> <input type="hidden" name="P_BUYERMOBILE"> <input type="hidden" name="P_EMAIL"> <input type="hidden" name="P_RESERVED"> <input type="hidden" name="P_CHARSET"> <input type="hidden" name="P_NEXT_URL"> <input type="hidden" name="P_NOTI_URL"> <input type="hidden" name="P_RETURN_URL">
                                <!---->
                                <input type="hidden" name="PayMethod" value="KAKAOPAY"> <input type="hidden" name="GoodsCnt" value="2"> <input type="hidden" name="GoodsName" value="세안밴드_베로니 외1개"> <input type="hidden" name="Amt"> <input type="hidden" name="supplyAmt"> <input type="hidden" name="goodsVat"> <input type="hidden" name="ServiceAmt"> <input type="hidden" name="BuyerName"> <input type="hidden" name="BuyerEmail" value="@"> <input type="hidden" name="certifiedFlag" value="CN"> <input type="hidden" name="merchantEncKey" value="976fc8abac61034d"> <input type="hidden" name="merchantHashKey" value="8ea49e8faa4265c2"> <input type="hidden" name="requestDealApproveUrl" value="https://kmpay.lgcns.com:8443/merchant/requestDealApprove.dev"> <input type="hidden" name="merchantTxnNum"> <input type="hidden" name="AuthFlg" value="10"> <input type="hidden" name="prType" value="WPM"> <input type="hidden" name="channelType" value="4"> <input type="hidden" name="possiCard"> <input type="hidden" name="maxInt"> <input type="hidden" name="fixedInt"> <input type="hidden" name="noIntYN"> <input type="hidden" name="noIntOpt"> <input type="hidden" name="pointUseYn"> <input type="hidden" name="blockCard"> <input type="hidden" name="resultCode"> <input type="hidden" name="resultMsg"> <input type="hidden" name="txnId"> <input type="hidden" name="prDt"> <input type="hidden" name="EdiDate"> <input type="hidden" name="EncryptData"> <input type="hidden" name="SPU"> <input type="hidden" name="SPU_SIGN_TOKEN"> <input type="hidden" name="MPAY_PUB"> <input type="hidden" name="NON_REP_TOKEN"> <input type="hidden" name="giftCardNumber"> <input type="hidden" name="giftCardAmount"> <input type="hidden" name="paymentAmount"> <input type="hidden" name="osDeliMoenyUse" value="N"> <input type="hidden" name="deliveryCharge" value="0"> <input type="hidden" name="ordDeliveryCharge" value="0"> <input type="hidden" name="osDeliType" value="1"> <input type="hidden" name="osDeliPayType" value="2"> <input type="hidden" name="payaplSaleId"> <input type="hidden" name="paypalPaymentId"> <input type="hidden" name="paypalPayerId"> <input type="hidden" name="paypalPayerEmail"> <input type="hidden" name="paypalCreateTime"> <input type="hidden" name="giftCardCodes"> <input type="hidden" name="oaBuyerEmail" value="@"> <input type="hidden" name="oaCountryName" value="한국"> <input type="hidden" name="oaEmail"> <input type="hidden" name="oaPhone" value="82-"> <input type="hidden" name="oaZoneCode"> <input type="hidden" name="oaAddr1"> <input type="hidden" name="oaAddr2"> <input type="hidden" name="oaAddr3"> <input type="hidden" name="defaultAddressType" value="D"> <input type="hidden" name="changeNationType" value="C"> <input type="hidden" name="oaBuyerCountryName" value="한국"> <input type="hidden" name="oaBuyerCountryCode" value="kr"> <input type="hidden" name="oaBuyerPhone" value="82-"> <input type="hidden" name="oaBuyerName"> <input type="hidden" name="pointPrice" value="0"></fieldset>
                            <fieldset class="fld_order">
                                <legend class="screen_out">주문하기 양식</legend>
                                <div class="order_cart">
                                    <h3 class="tit_orderit">상품 리스트</h3>
                                    <ul class="list_cart">
                                    
<%
double allPay=0;
	for(int i=0; i<result.size(); i++){
		GoodsBasketBean goods= (GoodsBasketBean)result.get(i);
		allPay += goods.getGPRICE()*goods.getGCOUNT();
%>                                    
                                        <li>
                                            <strong class="emph_cart"><!----></strong>
                                            <span class="wrap_thumb"><img alt="세안밴드_베로니" class="thumb_g" src="/KakaoFriends2/kakao_images/<%=goods.getGMAIN() %>"></span>
                                            <div class="desc_cart">
                                                ...
                                                <dl class="list_append">
                                                    ...
                                                    <dd class="usd_check">
                                                       <%=String.format("%.2f", goods.getGPRICE()*0.00088)%> USD
                                                    </dd>
                                                    <dt>옵션</dt>
                                                    <dd>-</dd>
                                                </dl>
               ...
               <hr>
                                    <div class="info_price">
                                        ...
                                        <dl class="list_price price_total">
                                            <dt style="font-size: 20pt;" ><b>총 상품 금액</b></dt>
                                            <dd>
                                                <strong class="txt_price">
                                                    <span class="usd_check usd_show">
                                                        <span class="num_price" style="font-size: 20pt;">
                                                            <%=allPay %> 원
                                                        </span>
                                                    </span>
                                                    <span class="usd_check">
                                                        <span class="num_price">
                                                            <%=String.format("%.2f", allPay*0.00088)%> USD
                                                        </span>
                                                    </span>
                                                </strong>
                                            </dd>
                                ...
                                <div class="order_detail order_form">
                                    
                                    <div class="group_order">
                                        <div class="info_order info_shipping">
                                            <h3 class="tit_orderit">주문자 정보</h3>
                             
                                            <dl class="list_inp">
                                                <dt>
                                                    <label for="tfoaN" class="lab_tf screen_out">이름</label>
                                                </dt>
                                                <dd><input id="ONAME" name="ONAME" type="text" placeholder="이름" class="tf_g"></dd>
                                            </dl>
                                         
                                            <dl class="list_inp list_phone">
                                                <dt class="screen_out">
                                                    <label for="oaPhone1" class="screen_out">휴대전화(숫자만 입력해 주세요)
                                                        <span class="screen_out">필수입력</span>
                                                    </label>
                                                </dt>
                                                <dd>
                                                    <input type="text" id="OPHONE" name="OPHONE" placeholder="휴대전화(숫자만 입력해 주세요)" class="tf_g tf_phone"></dd>
                                            </dl>
                                        </div>
                                        <div class="info_order info_shipping">
                                            <h3 class="tit_orderit">
                                               	 배송지 정보
                                            </h3>
                                            <div>
                                                <div class="choice_g on">
                                                    <label for="inpBasic" class="lab_g">기본 배송지</label>
                                                    <input type="radio" id="inpBasic" name="oaAddressType" value="D" class="inp_g">
                                                    <span class="ico_newfriends_v1 ico_choice"></span>
                                                </div>
                                                <div class="choice_g">
                                                    <label for="inpNew" class="lab_g">새로운 배송지</label>
                                                    <input type="radio" id="inpNew" name="oaAddressType" value="N" class="inp_g">
                                                    <span class="ico_newfriends_v1 ico_choice"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div>
                                                ...
                                                <dl class="list_inp">
                                                	 <dd>
                                                        <div class="sort_btn">
                                                            <button type="button" id="postcodify_search_button" class="btn_g global_hide">우편번호</button>
                                                        </div>
                                                    </dd>
                                  				    <dd><input type="text" name="ADDRESS1" class="postcodify_postcode5" value="" size="52" style="height: 40px;"/>  </dd> 
              										<dd><input type="text" name="ADDRESS2" class="postcodify_address" value="" size="52" style="height: 40px;"/><br /></dd> 
               										<dd><input type="text" name="ADDRESS3" class="postcodify_details" value="" size="52" id="OADDRESS" placeholder="상세주소 입력해주세요." style="height: 40px;"/><br /></dd> 
              										<dd><input type="text" name="ADDRESS4" class="postcodify_extra_info" value="" size="52" style="height: 40px;"/><br /> </dd>
              									</dl> 
                                            ...
                                            <dl class="list_inp list_memo">
                                                <dt>
                                                    <label for="osDeliMemo" class="lab_tf">배송메모
                                                        <span class="txt_limit">(0 / 50자)</span>
                                                    </label>
                                                </dt>
                                                <dd>
                                                    <textarea id="OMEMO" maxlength="50" name="OMEMO" placeholder="주소록 작성란이 아닙니다. 
배송 메모만 50자 이내로 작성해주세요." class="tf_g tf_textarea"></textarea>
                                                </dd>
                                            </dl>
                                            <div class="guide_bubble">
                                                <span class="ico_newfriends_v1 ico_arrow"></span>
                                                <p class="desc_bubble">주소, 상세주소 및 배송메모 작성 시 특수문자 &amp; &lt; &gt; ; 는 제외하고 입력해 주시기 바랍니다.</p>
                                                <!---->
                                            </div>
                                        </div>
                                        <div id="deliForm" class="info_order info_shippingfee">
                                            <h3 class="tit_orderit">배송비 정보</h3>
                                ...
                                <div class="order_detail order_agree list_agree">
                                    <div class="group_order">
                                        <h3 class="tit_orderit">약관 동의</h3>
                                        <ul class="list_agree">
                                            <li>
                                                ...
                                                <div class="chk_agree">
                                                    <div class="area_agree"><input type="checkbox" id="allAgree" name="saveId" class="inp_g">
                                                        <label for="allAgree" class="lab_g">
                                                            <span class="ico_newfriends_v1">동의</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            </li>
                                            <li>
                                                <strong class="tit_agree">
                                                    ...
                                                    <em class="emph_important">
                                                        (필수)</em>
                                                    <a class="link_agree">자세히보기</a>
                                                </strong>
                                                <div class="chk_agree">
                                                    <div class="area_agree"><input type="checkbox" id="checkAgree2" value="A" class="inp_g chkAgree">
                                                        <label for="checkAgree2" class="lab_g">
                                                            <span class="ico_newfriends_v1">동의</span>
                                                        </label>
                                                    </div>
                                                </div>
                                            ...
                                            <li>
                                                ...
                                                <div class="chk_agree">
                                                    <div class="area_agree"><input type="checkbox" id="checkAgree3" value="B" class="inp_g chkAgree">
                                                        <label for="checkAgree3" class="lab_g">
                                                            <span class="ico_newfriends_v1">동의</span>
                                                        </label>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="info_price">
                                            <dl class="list_price">
                                                ...
                                                <dd>
                                                    <span class="usd_check usd_show">
                                                        <strong>
                                                            <span class="num_price"><%=allPay %></span>
                                                          	  원
                                                        </strong>
                                                        <span class="txt_usd"><%=String.format("%.2f", allPay*0.00088)%> USD</span>
                                                    </span>
                                                    <span class="usd_check">
                                                        <strong>
                                                            <span class="num_price">
                                                               <%=String.format("%.2f", allPay*0.00088)%>
                                                            </span>
                                                            USD
                                                        </strong>
                                                    </span>
                                            ...
                                            <dl class="list_price">
                                                <dt>배송비</dt>
                                                <dd class="usd_check usd_show">
                                                    <strong id="delivery_price">
                                                        <span class="num_price">2500</span>원</strong>
                                                    <span class="txt_usd deliveryPrice">
                                                       2.33 USD
                                                    </span>
                                                </dd>
                                            ...
                                            <dl class="list_price price_total">
                                                <dt>총 결제금액</dt>
                                                <dd class="txt_total usd_check usd_show">
                                                    ...
                                                    <span class="txt_usd">
                                                       <%=String.format("%.2f", (allPay+2500)*0.00088)%> USD
                                                    </span>
                                                </dd>
                               ...
                               <br>
                               <br>
                                <div data-v-7c7e9dba="" class="order_btn">
                                    <button  type="button" class="btn_order btn_payment" onclick="orderlist_gogo();">
                                        <span data-v-7c7e9dba="" class="txt_g">결제하기</span>
                                    </button>
                                </div>
                            </fieldset>
                        </form>
...
<script src="./resources/js/friends-detail.js?2018a0a85aaad7e1459eb082afc71a02254320kfo-store-web2.dakao.io5750"></script>
...
<script type="text/javascript" language="javascript">
		// form 액션에서 함수 호출
		function validate() {
			if ( nameValidate()&&phoneValidate()&&homeAddressValidate()) {
				return true;
			} else {
				return false;
		...
		function homeAddressValidate() {
			...
			var objAddress = document.getElementById("OADDRESS");
		...
		function nameValidate() {
			var nameCheck = /^[a-zA-Z0-9가-힣\s]{1,30}$/; // 소문자, 대문자, 숫자, 한글 4자리에서~30자리까지 입력가능
			var objName = document.getElementById("ONAME");
		...
		function phoneValidate() {
			var phoneCheck = /^[0-9]{4,30}$/; // 소문자, 대문자, 숫자, 한글 4자리에서~30자리까지 입력가능
			var objPhone = document.getElementById("OPHONE");
			var phoneOk = phoneCheck.exec(objPhone.value);
			if (phoneOk) {
				return true;
			} else {
				alert("전화번호 형식이 틀립니다.");
